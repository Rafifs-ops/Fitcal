...
const { articles } = storeToRefs(data); // Mendapatkan data articles dari pinia dan menjaga reaktivitas
onMounted(async () => {
    await data.fetchArticles(); // Menjalankan fungsi yang ada di dalam state pinia untuk mendapatkan data
})
</script>
